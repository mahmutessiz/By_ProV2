...
namespace By_ProV2
{
    public partial class SutEnvanteriWindow : Window
    {
        ...
        private void btnKaydet_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                // Only allow creating a new record if it's for today and no record exists yet
                ...
                {
                    MessageBox.Show("Bu tarih için zaten envanter kaydı mevcut. Lütfen Güncelle butonunu kullanın.", 
